...
//
   ...
   //SCToolbarbackground: "background-color:#FFF !important",
   //SCTabbackground: "background-color:#FFF !important",
   ...
   //SCTabplainCSS: "font-size:small;padding:6px 30px 6px 8px;color:#FFF;background-color:#FFF;cursor:default;border-right:1px solid #CCC;",
